...
//		return counterSection;
	...
	public static void sectionsLength() {
	System.out.println("Number of times letter repetition: ");
	 for(int a=0;a<array.length;a++) {
		 System.out.println((char)(a+97)+" : "+ array[a]);
	 }
		
	}
	
 
	public static void sectionsLength(char c) {
		...
		while(length!=counter) {
			...
			if(c==(leaderNode.value.charAt(0))) {
				System.out.println(leaderNode.value);
			}
			leaderNode =leaderNode.next;
			counter++;
		}
